...
public class PriceRepositoryTest {
	...
	public void testFindByRouteAndDates() {
		...
		// When
		List<Price> aux = this.priceRepository.findByRouteAndDates(route, fromDate, toDate);

		// Then
		assertThat(price.getId()).isEqualTo(aux.get(0).getId());
		assertThat(price.getFromDate()).isEqualTo(aux.get(0).getFromDate());
		assertThat(price.getToDate()).isEqualTo(aux.get(0).getToDate());
	}
